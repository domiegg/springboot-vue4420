...
<div class="search">
        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="orderName">
                        <Input type="text" v-model="searchForm.orderName" placeholder="下单人" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item style="margin-left:10px;" class="br">
                        ...
                        <Button @click="delAll" type="error" icon="md-trash" size="small" ghost>取消加购</Button>
    ...
    <Modal v-model="buyModal" title="请确认下单" :mask="false" footer-hide draggable width="800">
        <Form :label-width="100" label-position="left">
            <Row :gutter="16">
                <Col span="24">
                <FormItem label="下单地址">
                    <Input v-model="buyAddress" type="textarea" :rows="4" show-word-limit maxlength="240" placeholder="请输入下单地址..." style="width:100%" />
                </FormItem>
                </Col>
                <Col span="24">
                <FormItem label="预约时间">
                    <DatePicker type="date" placeholder="请选择预约时间..."  format="yyyy-MM-dd" @on-change="changeBuyDate" style="width: 100%"></DatePicker>
                </FormItem>
                </Col>
                <Col span="24">
                <Divider>
                    <Button @click="orderOrderFx" :loading="buyLoading" type="success">确认下单</Button>
                </Divider>
                </Col>
            </Row>
        </Form>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getDishOrderList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
