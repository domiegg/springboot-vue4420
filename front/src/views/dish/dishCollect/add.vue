...
<div>
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="收藏人ID" prop="collectId">
                <Input v-model="form.collectId" clearable style="width:570px" />
            </FormItem>
            <FormItem label="收藏人" prop="collectName">
                <Input v-model="form.collectName" clearable style="width:570px" />
            </FormItem>
            <FormItem label="收藏时间" prop="collectTime">
                <Input v-model="form.collectTime" clearable style="width:570px" />
            </FormItem>
            <Form-item class="br">
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    addDishCollect(this.form).then(res => {
