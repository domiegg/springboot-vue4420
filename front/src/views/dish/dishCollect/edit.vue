    ...
    <Card>
        <div slot="title">
            <div class="edit-head">
                ...
                <div class="head-name">药品收藏详情</div>
                <span></span>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="收藏人" prop="collectName">
                <Input v-model="form.collectName" readonly style="width:570px" />
            </FormItem>
            <FormItem label="收藏时间" prop="collectTime">
                <Input v-model="form.collectTime" readonly style="width:570px" />
            </FormItem>
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    editDishCollect(this.form).then(res => {
