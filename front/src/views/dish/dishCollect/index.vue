        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="collectName">
                        <Input type="text" v-model="searchForm.collectName" placeholder="收藏人" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item style="margin-left:10px;" class="br">
                        ...
                        <Button @click="delAll" type="error" icon="md-trash" size="small" ghost>取消收藏</Button>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getDishCollectList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
